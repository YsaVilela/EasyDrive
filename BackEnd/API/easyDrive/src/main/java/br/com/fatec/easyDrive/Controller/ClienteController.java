...
public class ClienteController {
	...
	public ResponseEntity<Optional<DadosDetalhamentoCliente>> cadastrar(
			@RequestBody @Valid DadosCliente dados) {
		return ResponseEntity.status(HttpStatus.CREATED).body(service.cadastrar(dados));
	}

	@GetMapping("/buscarId/{id}")
	public ResponseEntity<Optional<DadosDetalhamentoCliente>> buscarId(@PathVariable Long id) {
	...
	@Transactional
	public ResponseEntity<Optional<DadosDetalhamentoCliente>> atualizar(
